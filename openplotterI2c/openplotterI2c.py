...
class MyFrame(wx.Frame):
	def __init__(self):
		...
		self.i2c_sensors_def['BMP581'] = {'magnitudes': [_('pressure'),_('temperature')], 'SKkeys': ['environment.outside.pressure',''], 'sensorSettings': {'pressure_oversampling':'4', 'temperature_oversampling':'2'}, 'multiplexing':True}
